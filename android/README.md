...
1. **Models:** browse the shared 39-model catalog, including 4B entries, or search Hugging Face. Open a repository, review the license, and choose a single-file GGUF. Add a Hugging Face token in Settings for gated repositories, after accepting their terms on the model card. Safetensors, sharded GGUFs, and vision projectors are not supported.
